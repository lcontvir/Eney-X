...
public class PrivacidadAdaptador extends RecyclerView.Adapter<PrivacidadAdaptador.PrivacidadViewHolder> {
    ...
    public void onBindViewHolder(@NonNull PrivacidadViewHolder holder, int position) {
        ...
        holder.tvNotificaciones.setText("Notificaciones:                 " + privacidad.isNotificaciones());
        holder.tvGalletasAnaliticas.setText("Galletas Analíticas:             " + privacidad.isGalletasAnaliticas());
        holder.tvGalletasMarketing.setText("Galletas de Marketing:            " + privacidad.isGalletasMarketing());
        ...
        if (privacidad.isNotificaciones()) {
        ...
        if (privacidad.isGalletasAnaliticas()) {
        ...
        if (privacidad.isGalletasMarketing()) {
