...
public class LicenciasAdaptador extends RecyclerView.Adapter<LicenciasAdaptador.LicenciasViewHolder> {
    ...
    public LicenciasAdaptador(Context context, List<Licencias> listaLicencias, String textoLicencia) {
    ...
    public void onBindViewHolder(@NonNull LicenciasViewHolder holder, int position) {
        Licencias licencia = listaLicencias.get(position);

        holder.tvIdLicencia.setText("Id:                            " +(licencia.getId()));
        holder.tvNombreLicencia.setText("Nombre:                 " + licencia.getNombre());
        holder.tvCodigoLicencia.setText("Código:                    " + licencia.getCodigo());
        holder.tvDescripcionLicencia.setText("Descripción:  " + licencia.getDescripcion());
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(context, "ID: " + licencia.getId(), Toast.LENGTH_SHORT).show();
            }
        });
    }
