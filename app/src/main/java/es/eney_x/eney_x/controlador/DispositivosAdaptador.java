...
import es.eney_x.eney_x.modelo.Dispositivo;
...
public class DispositivosAdaptador extends RecyclerView.Adapter<DispositivosAdaptador.DispositivosViewHolder> {
    ...
    public DispositivosAdaptador(Context context, List<Dispositivo> listaDispositivos,  String textoLicencia) {
    ...
    public void onBindViewHolder(@NonNull DispositivosViewHolder holder, int position) {
        ...
        holder.tvIdDispositivo.setText("Dispositivo:            " + "Tu dispositivo");
        holder.tvProtegido.setText("Protegido:               " + (dispositivo.isActivo() ? "Sí" : "No"));
